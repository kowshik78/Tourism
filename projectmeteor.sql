...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2021 at 12:06 AM
...
(111, 'ami@gmail.com', '29-10-2021', 'no', 'New Delhi', 'Kolkata', 4, 'ReturnTripFlight');
...
('CCU-085', 'Kolkata', 'New Delhi', 0, 7015, 'Economy', 19, '20:05', '05:40', 'AirIndia', 'CCU', 'DEL', 'Non-Refundable', 4),
...
('DEL-123', 'New Delhi', 'Kolkata', 0, 6830, 'Economy', 32, '6:35', '8:55', 'AirAsia', 'DEL', 'CCU', 'Refundable', 4),
...
CREATE TABLE `landmark` (
  ...
  `location` varchar(25) CHARACTER SET utf8mb4 NOT NULL,
  `details` varchar(1000) CHARACTER SET utf8mb4 NOT NULL,
  `price` int(11) DEFAULT NULL,
  `zone` varchar(255) CHARACTER SET utf8mb4 DEFAULT NULL
...
INSERT INTO `landmark` (`destinationId`, `title`, `location`, `details`, `price`, `zone`) VALUES
(1, 'পতেঙ্গা সি বিচ', 'Bandorban', 'পতেঙ্গা বঙ্গোপসাগরের একটি সমুদ্র সৈকত, যা বাংলাদেশের বন্দর শহর চট্টগ্রাম থেকে ১ kilometers কিলোমিটার দক্ষিণে অবস্থিত।', 2200, 'CH'),
(2, 'Foy’s Lake Concord', 'Bandorban', 'ফয়েস লেক কনকর্ড ফয় লেক কনকর্ড অ্যামিউজমেন্ট ওয়ার্ল্ড এবং ফয় লেক এমিউজমেন্ট ওয়ার্ল্ড নামেও পরিচিত, এটি বাংলাদেশের চট্টগ্রামের প্রাণকেন্দ্রে ফয় লেকে অবস্থিত একটি থিম পার্ক।', 2000, 'CH'),
(9, 'প্রজাপতি পার্ক বাংলাদেশ', 'চট্টগ্রাম', 'গ্রীষ্মমন্ডলীয় উদ্যান এবং প্রজাপতি পার্ক', 1100, 'CH'),
(10, 'Radiant Fish World', 'কক্সবাজার', 'আপনি কি অনাবিষ্কৃত সমুদ্র জগতে ঘুরে বেড়াতে ভালোবাসেন রেডিয়েন্ট ফিশ ওয়ার্ল্ড হল কিছু জ্ঞান সহ অ্যাডভেঞ্চার দেখার জায়গা। এটি বাংলাদেশের প্রথম', 1500, 'CH'),
(12, 'Radiant Fish World', 'কক্সবাজার', 'আপনি কি অনাবিষ্কৃত সমুদ্র জগতে ঘুরে বেড়াতে ভালোবাসেন রেডিয়েন্ট ফিশ ওয়ার্ল্ড হল কিছু জ্ঞান সহ অ্যাডভেঞ্চার দেখার জায়গা। এটি বাংলাদেশের প্রথম', 1500, 'CH'),
(13, 'রাতারগুল সোয়াম্প ফরেস্ট', 'গোয়াইনঘাট উপজেলা', 'রাতারগুল একটি প্রাকৃতিক বন, স্থানীয় বন বিভাগ এখানে হিজল, বরুণ, করচ সহ বেশ কিছু গাছ রোপণ করেন। এছাড়াও এখানে চোখে পড়ে কদম, জালিবেত, অর্জুনসহ প্রায় ২৫ প্রজাতির জলসহিষ্ণু গাছপালা', 5000, 'SY'),
(14, 'বিছনাকান্দি', 'গোয়াইনঘাট উপজেলার রুস্তমপ', 'পর্যটকদের কাছে বিছানাকান্দির মূল আকর্ষন হচ্ছে পাথরের উপর দিয়ে বয়ে চলা স্বচ্ছ জলধারা আর পাহাড়ে পাহাড়ে শুভ্র মেঘের উড়াউড়ি। প্রথম দেখায় আপনার মনে হবে এ যেন এক পাথরের বিছানা, আর স্বচ্ছ পানিতে গা এলিয়ে দিতেই যে মানসিক প্রশান্তি পাবেন', 1200, 'SY'),
(15, 'জাফলং', 'ভারতের মেঘালয় সীমান্ত ঘেঁ', 'পাথরের উপর দিয়ে বয়ে চলা পিয়াইন নদীর স্বচ্ছ পানির ধারা, ঝুলন্ত ডাউকি ব্রিজ, উঁচু উঁচু পাহাড়ে সাদা মেঘের খেলা জাফলংকে করেছে অনন্য। একেক ঋতুতে জাফলং একেক রকম রুপের প্রকাশ ঘটায়, যা পর্যটকদেরকে ভ্রমণের জন্য সারাবছরই আগ্রহী করে রাখে', 5410, 'SY'),
(16, 'ভোলাগঞ্জ', ' কোম্পানিগঞ্জ উপজেলা', 'পাহাড় থেকে নেমে আসা ঝর্ণাধারা একদিকে ধলাই নদের পানির যোগানদাতা অন্যদিকে এই পানি প্রবাহই ভোলাগঞ্জের রূপের উৎস। সবুজ পাহাড়, মেঘের হাতছানি আর বর্ষার পাহাড়ি ঢলের সাথে নেমে আসা সাদা পাথর ধলাই নদের বুকে মিলে মিশে ভোলাগঞ্জের সৌন্দর্য্য বাড়িয়ে দিয়েছে বহুগুণ।', 2000, 'SY'),
(17, 'সাফিনা পার্ক', 'গোদাগাড়ী উপজেলার দ্বিগ্র', 'নারকম ফুল, ফল ও ঔষধি গাছ দিয়ে ঘেরা পার্কের ভিতরে রয়েছে দৃষ্টিনন্দন ফোয়ারা ও কৃত্রিম উপায়ে তৈরিকৃত বিভিন্ন পশু পাখির আকর্ষণীয় ভাস্কর্য। শিশুদের বিনোদনের জন্য রয়েছে নাগরদোলা, দোলনা, ট্রেন, থ্রিডি সিনেমা এবং কিডস স্পোর্টস জোন। দর্শনার্থীরা ইচ্ছে করলে পার্কের ভিতরে বিদ্যমান দুইটি লেকে নৌকায় ঘুরে বেড়াতে পারেন।', 4550, 'RAJ'),
(18, 'রাজশাহী কেন্দ্রীয় চিড়িয', 'রেসকোর্স ময়দানে', 'চিড়িয়াখানার প্রধান প্রবেশ গেইটে বিদ্যমান জিরাফের বিশাল ভাস্কর্য ও মৎস্য কুমারীর ফোয়ারা নজরে পড়ে। নানারকম ফুল, ফল ও ঔষধি গাছের ছায়া ঘেরা পার্কের ভিতরে আছে বিভিন্ন দৃষ্টিনন্দন ভাস্কর্য ও নান্দ্যনিক ব্রিজ সহ একটি ছোট্ট লেক। চিড়িয়াখানায় উল্লেখযোগ্য সংগ্রহের মধ্যে রয়েছে বাজরিকা, বালিহাস', 4250, 'RAJ'),
(19, 'হালতির বিল', 'নলডাঙ্গা থানা', 'হালতির বিল যাওয়ার পথে পাটুল থেকে খাজুরা পর্যন্ত রাস্তার সৌন্দর্য, উত্তাল ঢেউয়ে প্রবাহমান জলরাশি আর উদ্দাম বাতাস দর্শনার্থীদের মনকে সতেজ করে তোলে। উত্তরাঞ্চলের অনেকে তাই এই বিলকে মিনি সমুদ্র সৈকত হিসেবে আখ্যায়িত করেন।', 8520, 'RAJ'),
(20, 'চলনবিল জাদুঘর', 'গরুদাসপুর থানা', ' চলনবিলের বিভিন্ন ঐতিহাসিক নিদর্শন নিয়ে তৈরী এ জাদুঘরটি ১৯৮৯ সালের ২ জুলাই প্রত্নতত্ত্ব অধিদপ্তরের আওতাভুক্ত হয়। চলনবিল জাদুঘরে উল্লেখযোগ্য প্রত্নতাত্ত্বিক নিদর্শনের মধ্যে আছে বিষ্ণু ও মাতৃকা মূর্তিসহ নানা গবেষণা গ্রন্থ, কষ্টি পাথরের সূর্যদেব, ডাক টিকিট, ৯০টি দেশের মুদ্রা, ঘট, শিলা এবং বিভিন্ন শাসন আমলের টেরাকোটা।', 1300, 'RAJ'),
(21, 'ভূতিয়ার পদ্মবিল', 'তেরখাদা উপজেলা', ' ভূতিয়ার পদ্মবিল আবহমান গ্রাম বাংলার অপরূপ প্রকৃতির প্রতিচ্ছবি, যা আগের মত আর সবখানে দেখা যায় না। সকাল ৬টা থেকে ৬টা ৩০ মিনিট পর্যন্ত পদ্ম ফুল দেখতে সবচেয়ে উপযুক্ত সময়। কারণ বেলা যতই বাড়তে থাকে পদ্মও ফুলের ততই পাপড়ি বুজে যেতে থাকে।', 1000, 'KHU'),
(22, 'পুটনী দ্বীপ', 'খুলনা জেলা', 'রিণ আর মাছের অভয়ারণ্য হওয়ার কারণে পুটনী দ্বীপে জেলে ও সাধারণ মানুষের তেমন আনাগোনা নেই। তবে আশেপাশের স্থানীয় অনেকেই কাকড়া আহরণ করতে পুটনী আইল্যান্ডে এসে থাকেন। এই দ্বীপের জঙ্গল ও খালে হরিণ এবং মাছের বিচরণ থাকলেও জানা যায় এখানে কোন বাঘের উপদ্রব নেই।', 2500, 'KHU'),
(23, 'খান জাহান আলী সেতু', 'খুলনার রূপসা নদী', 'রূপসা সেতুর দৈর্ঘ্য ১.৬০ কিলোমিটার। ব্রিজে পথচারী ও অযান্ত্রিক যানবাহনের যাতায়াতের জন্য রয়েছে বিশেষ লেনের ব্যবস্থা। এছাড়া মূল সেতুতে উঠার জন্য সেতুর দুই প্রান্তে দুটি করে মোট চারটি সিঁড়ি রয়েছে।', 4500, 'KHU'),
(24, 'করমজল পর্যটন কেন্দ্র', ' সুন্দরবনে পশুর নদীর তীরে', 'মংলা থেকে ইঞ্জিন চালিত নৌকায় করমজল পর্যটন কেন্দ্রে পৌঁছাতে এক থেকে দেড় ঘণ্টা সময় লাগে। পর্যটন কেন্দ্রের প্রথমেই রয়েছে সুন্দরবনের মানচিত্র, যা সুন্দরবন সম্পর্কে মানচিত্র প্রাথমিক ধারণা দেয়। সামনে আঁকাবাঁকা কাঠের তৈরি মাঙ্কি ট্রেইল নামের হাঁটা পথ ধরে এগিয়ে গেলে সুন্দরবনের জীববৈচিত্রের সমৃদ্ধতা সম্পর্কে অনুমান করা যায়।', 2000, 'KHU'),
(25, 'রোজ গার্ডেন প্যালেস', ' ঢাকার টিকাটুলি', 'হৃষিকেস দাস ছিলেন নিন্মবর্ণের ফলে এক জলসায় তিনি অপমানের স্বীকার হন। এরপর হৃষিকেস দাস বিনোদনের জন্য রোজ গার্ডেন প্যালেস তৈরী করেন এবং এখানেই জলসার আয়োজন করতেন। ঐ সময়ে এই বাগানবাড়ির নয়নাভিরাম সাজঘর ছিল মূল আকর্ষণ।', 2500, 'DHA'),
(26, 'নেভারল্যান্ড', 'আশুলিয়া বেড়িবাঁধ', 'তামান্না ওয়ার্ল্ড ফ্যামিলি পার্ক-এর কাছে অবস্থিত তুরাগ নদী দিয়ে ঘেরা সাজানো গুছানো নেভারল্যান্ড পিকনিক স্পটে আছে বাংলা ও চাইনিজ খাবারের রেস্টুরেন্ট, বাচ্চাদের জন্য প্লে জোন, কার পার্কিং এবং নৌ-ভ্রমনের ব্যবস্থা। এছাড়া বেড়িবাঁধ ধরে নেভারল্যান্ড পার্কে যাওয়ার রাস্তাটি খুবই উপভোগ্য। ', 1000, 'DHA'),
(27, 'রাজা হরিশচন্দ্রের ঢিবি', 'সাভার উপজেলা', 'ব্বইয়ের দশকে এক খননের ফলে এই প্রত্নতাত্ত্বিক ঐতিহ্যের সন্ধান পাওয়া যায়। রাজা হরিশচন্দ্রের ঢিবি থেকে প্রাপ্ত নিদর্শনের মধ্যে রয়েছে হরিকেল রৌপ্যমুদ্রা, স্বর্ণমুদ্রা এবং ব্রোঞ্জের তৈরি বুদ্ধমূর্তি। যা বর্তমানে বাংলাদেশ জাতীয় জাদুঘরে সংরক্ষিত আছে।', 2000, 'DHA'),
(28, 'জিঞ্জিরা প্রাসাদ', 'বুড়িগঙ্গা নদীর অন্য পাড়ে', 'দেশীয় গাছগাছালির ছায়া ঘেরা অপূর্ব কারুকার্যখচিত জিঞ্জিরা প্রাসাদে যাওয়া আসার জন্য কাঠের পুল ব্যবহার করা হত। কথিত আছে, পলাশীর যুদ্ধে পরাজয়ের পর সিরাজদ্দৌলার পরিবারকে জিনজিরা প্রাসাদে প্রেরণ করা হয়েছিল। স্থানীয়দের মধ্যে প্রচলিত আছে, লালবাগ কেল্লার সাথে জিঞ্জিরা প্রাসাদে যোগাযোগের জন্য বুড়িগঙ্গার তলদেশ দিয়ে একটি সুড়ঙ্গ তৈরি করা হয়েছিল', 4500, 'DHA'),
(29, 'শংকর মঠ', 'বরিশাল জেলা শহরের', 'তিন গম্বুজ বিশিষ্ট শংকর মঠের শীর্ষে স্থাপিত রয়েছে ধাতু নির্মিত ‘ওঁ’ চিহ্ন এবং একটি ত্রিশূল। শংকর মঠের অভ্যন্তরে তিনটি কক্ষ রয়েছে। মঠের মূল কক্ষে একটি কষ্টিপাথরে নির্মিত শিবলিঙ্গ রাখা আছে। আর দুইপাশের একটি কক্ষে আছে শংকরানন্দের বিগ্রহ এবং অন্যটিতে স্বামী প্রজ্ঞানানন্দ সরস্বতীর সমাধি মন্দির', 2000, 'BAR'),
(30, 'অক্সফোর্ড মিশন', 'বগুড়াগামী রোডে', 'ক্সফোর্ড মিশন চার্চটি দেখতে একতলা হলেও উচ্চতায় এটি ৫ তলা ভবনের সমান। আকর্ষণীয় এ গির্জাটি গ্রিক স্থাপত্য শৈলীর অনুকরণে নির্মিত হয়েছে। প্রাচীর পেরিয়ে ভেতরে ঢুকলেই একে একে চোখে পরে সবুজ ঘাসের মাঠ, খেলার মাঠ, পুকুর, অক্সফোর্ড মিশন প্রাইমারি স্কুল ও হাই স্কুল, লাইব্রেরি, হাসপাতাল, ছাত্রছাত্রী হোস্টেল, ফুলের বাগান এবং নানা প্রজাতির ঔষধি গাছ।', 1000, 'BAR'),
(31, 'গুটিয়া মসজিদ', ' বরিশাল বিভাগে উজিরপুর থা', 'গুটিয়া মসজিদ কমপ্লেক্সের ভেতরে রয়েছে একটি মসজিদ, সুদৃশ্য মিনার, ২০ হাজার লোকের ধারণক্ষমতার ঈদগাহ্ ময়দান, একটি ডাকবাংলো, এতিমখানা, গাড়ি পার্কিং, পুকুর, লেক এবং ফুলের বাগান। মসজিদটিতে এক সঙ্গে প্রায় ১৫০০ মুসল্লী নামাজ আদায় করতে পারে এবং মসজিদটির মিনারের উচ্চতা প্রায় ১৯৩ ফুট।', 4500, 'BAR'),
(32, 'শাপলা গ্রাম, সাতলা', 'সাতলা ', 'সাতলা গ্রামের প্রায় ১০ হাজার একর জলাভূমিতে শাপলা জন্মে। শাপলা গ্রামের অধিকাংশ অধিবাসী তাই শাপলা বিপণনের সাথে যুক্ত। শাপলা গ্রাম সাতলা থেকেই সারা দেশের বিভিন্ন জায়গায় শাপলা ফুল সরবরাহ করা হয়। শাপলার ছবি তোলার জন্য ফটোগ্রাফারদের কাছে সাতলা একটি আদর্শ জায়গা', 2500, 'BAR');
...
(1, '2', 'BLR001', 3, '2021-10-30 21:41:34'),
(2, '2', 'BLR002', 3, '2021-10-30 21:41:41'),
(3, '2', 'BLR003', 5, '2021-10-30 21:41:46'),
(4, '2', 'BLR004', 4, '2021-10-30 21:41:50'),
(5, '3', 'BLR005', 5, '2021-10-30 21:41:55'),
(6, '4', 'BLR006', 4, '2021-10-30 21:41:59'),
(80, '4', 'BLR008', 4, '2021-10-30 21:42:03'),
(81, '100', 'BLR001', 3, '2021-10-30 22:01:45');
...
(18, 'Kow', 'kowshiksaha78@gmail.com', '1625869040', 'ami@gmail.com', '$2a$08$lUv/XTyrKLgFSQoG4TDBpeoaLUe884BGioCU27k8HA9o.17MlPYxe', 'hello ajimpur', 'ghjffff', 'Dhaka', 'BD', 'Monday 6th of September 2021 at 11:54:21 PM'),
(22, 'dfs', 'kowshiksaha78@gmail.com', '9852314567', 'ami@mail.com', '1234', 'hello ajimpur', 'ghjffff', 'Dhaka', 'BD', 'Wednesday 8th of September 2021 at 01:30:51 AM');
...
--
ALTER TABLE `flightbookings`
  MODIFY `bookingID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;
